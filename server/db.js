...
async function readDb() {
  ...
  for (const uid of Object.keys(db.userdata)) {
    ...
    if (settings && !settings.diary) settings.diary = { showDecimalMacros: false, quickAddEnabled: true, multiAddDefault: false, suggestRecentMeals: false, defaultSearchTab: 'all' };
